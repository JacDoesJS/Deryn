...
//Arrange
const airportB = new Airport("calm");
...
//Arrange
const airportE = new Airport("calm");

//Act
actual = airportE.land("Mango 12");
...
//Arrange
const airportF = new Airport("calm");
const airportG = new Airport("calm");
airportF.land("Mango 12");
airportF.land("Orange 7");
airportF.land("Spitfire 633")
airportG.land("Big Red 1");

//Act
actual = airportF.trackPlanes(), airportG.trackPlanes();
